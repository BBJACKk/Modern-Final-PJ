...
This notebook is written as a complete, submission-ready workflow for the final project. It follows the assignment requirements in a transparent order: data preparation, sequence construction, patient-level splitting, baseline modelling, improved modelling, hyperparameter tuning, evaluation, and discussion.
